...
# Plot (a) - Latent variable space (theta)
...
# Plot (b) - Real coordinate space (zeta)
...
fig.update_layout(
    ...
    margin=dict(l=50, r=50, t=80, b=50) # Add margins to prevent cutoff
)
...
# --- 5. Add Annotations for Transformations ---
...
# --- 6. Ensure directory exists and save Plot ---
output_dir = "images"
...
print(f"Figure saved to {output_file}") # Optional confirmation message